...
<body class="preload-wrapper color-primary-13">
    <!-- RTL -->
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="wrap-slider">
                                    <img class="lazyload" data-src={{ asset("frontend/asset/images/slider/book-store-1.png") }}
                                        src={{ asset("frontend/asset/images/slider/book-store-1.png") }} alt="book-store-01">
                                    <div class="box-content">
                                        <div class="container">
                                            <h2
                                                class="fade-item fade-item-1 fw-6 text_white heading font-libre-baskerville mb_14">
                                                Books that shape <br> minds</h2>
                                            <p class="fade-item fade-item-2 text_white">Find Inspiration One Page at a
                                                Time</p>
                            ...
                            <div class="swiper-slide">
                                <div class="wrap-slider">
                                    <img class="lazyload" data-src={{ asset("frontend/asset/images/slider/book-store-2.png") }}
                                        src={{ asset("frontend/asset/images/slider/book-store-2.png") }} alt="book-store-02">
                                    <div class="box-content">
                                        <div class="container">
                                            <h2
                                                class="fade-item fade-item-1 fw-6 text_white heading font-libre-baskerville mb_14">
                                                Find your next <br> favorite book</h2>
                                            <p class="fade-item fade-item-2 text_white">From Bestsellers to Hidden Gems
                                            </p>
                                            <a href="shop-default.html"
                                                class="fade-item fade-item-3 tf-btn btn-light-icon animate-hover-btn btn-xl radius-3"><span>Shop
                                                    collection</span><i class="icon icon-arrow-right"></i></a>
                            ...
                            <div class="swiper-slide">
                                <div class="wrap-slider">
                                    <img class="lazyload" data-src={{ asset("frontend/asset/images/slider/book-store-3.png") }}
                                        src={{ asset("frontend/asset/images/slider/book-store-3.png") }} alt="book-store-03">
                                    <div class="box-content">
                                        <div class="container">
                                            <h2
                                                class="fade-item fade-item-1 fw-6 text_white heading font-libre-baskerville mb_14">
                                                Books that speak <br> to your soul</h2>
                                            <p class="fade-item fade-item-2 text_white">Uncover Tales That Inspire,
                                                Motivate, and Captivate</p>
                                            <a href="shop-default.html"
                                                class="fade-item fade-item-3 tf-btn btn-light-icon animate-hover-btn btn-xl radius-3"><span>Shop
                                                    collection</span><i class="icon icon-arrow-right"></i></a>
                                        </div>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="collection-item-v4 hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-collection-sub.html" class="collection-image img-style radius-20">
                                            <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-7.png") }}
                                                src={{ asset("frontend/asset/images/collections/cls-book-store-7.png") }} alt="collection-img">
                                        </a>
                                        <div class="collection-content wow fadeInUp" data-wow-delay="0s">
                                            <p class="subheading text_white">30% OFF</p>
                                            <h5 class="heading text_white">Endless Pages, <br> Endless Possibilities
                                            </h5>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item-v4 hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-collection-sub.html" class="collection-image img-style radius-20">
                                            <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-8.png") }}
                                                src={{ asset("frontend/asset/images/collections/cls-book-store-8.png") }} alt="collection-img">
                                        </a>
                                        <div class="collection-content wow fadeInUp" data-wow-delay="0s">
                                            <p class="subheading text_white">FREE DELIVERY</p>
                                            <h5 class="heading text_white">For the Love of <br> Reading</h5>
                                            <a href="shop-collection-list.html"
                                                class="tf-btn style-2 btn-light-icon radius-3 animate-hover-btn border-0">Shop
                                                now</a>
                                        </div>
                            ...
                            <div class="swiper-slide">
                                <div class="collection-item-v4 hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-collection-sub.html" class="collection-image img-style radius-20">
                                            <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-9.png") }}
                                                src={{ asset("frontend/asset/images/collections/cls-book-store-9.png") }} alt="collection-img">
                                        </a>
                                        <div class="collection-content wow fadeInUp" data-wow-delay="0s">
                                            <p class="subheading text_white">MUST HAVE</p>
                                            <h5 class="heading text_white">Dive into the World <br> of Words</h5>
                                            <a href="shop-collection-list.html"
                                                class="tf-btn style-2 btn-light-icon radius-3 animate-hover-btn border-0">Shop
                                                now</a>
                                        </div>
        ...
        <section class="flat-spacing-12">
            <div class="container">
                <div class="flat-title flex-row justify-content-between align-items-center px-0 wow fadeInUp"
                    data-wow-delay="0s">
                    <h3 class="title font-libre-baskerville fw-7">Season Collection</h3>
                    ...
                    <div dir="ltr" class="swiper tf-sw-collection" data-preview="6" data-tablet="3" data-mobile="2"
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-1.png") }}
                                            src={{ asset("frontend/asset/images/collections/cls-book-store-1.png") }} alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <a href="shop-collection-sub.html" class="link title fw-5">Fantasy</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-2.png") }}
                                            src={{ asset("frontend/asset/images/collections/cls-book-store-2.png") }} alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <a href="shop-collection-sub.html" class="link title fw-5">Romance</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-3.png") }}
                                            src={{ asset("frontend/asset/images/collections/cls-book-store-3.png") }} alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <a href="shop-collection-sub.html" class="link title fw-5">Architecture</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-4.png") }}
                                            src={{ asset("frontend/asset/images/collections/cls-book-store-4.png") }} alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <a href="shop-collection-sub.html" class="link title fw-5">Children's
                                            Fiction</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-5.png") }}
                                            src={{ asset("frontend/asset/images/collections/cls-book-store-5.png") }} alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <a href="shop-collection-sub.html" class="link title fw-5">Comics & Graphic</a>
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item-circle hover-img">
                                    <a href="shop-collection-sub.html" class="collection-image img-style">
                                        <img class="lazyload" data-src={{ asset("frontend/asset/images/collections/cls-book-store-6.png") }}
                                            src={{ asset("frontend/asset/images/collections/cls-book-store-6.png") }} alt="collection-img">
                                    </a>
                                    <div class="collection-content text-center">
                                        <a href="shop-collection-sub.html" class="link title fw-5">Westerns</a>
            ...
            <div class="container">
                <div
                    ...
                    <div class="store-item-info">
                        <h5 class="store-heading font-libre-baskerville fw-7">New York Times <br>Bestsellers</h5>
                        <div class="description">
                            <p class="">Stay current on the most popular books as listed by the NY Times.</p>
                        </div>
                    ...
                    <div class="store-img img-style">
                        <img class="lazyload" data-src={{ asset("frontend/asset/images/shop/store/book-store-1.png") }}
                            src={{ asset("frontend/asset/images/shop/store/book-store-1.png") }} alt="store-img">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="flat-animate-tab">
                    <div class="flat-title flex-row justify-content-between align-items-center px-0  flex-wrap wow fadeInUp"
                        data-wow-delay="0s">
                        <h3 class="title font-libre-baskerville fw-7">Popular by Genre</h3>
                        <ul class="widget-tab-5 d-flex wow fadeInUp mb-0" data-wow-delay="0s" role="tablist">
                            <li class="nav-tab-item" role="presentation">
                                <a href="#all-genres" class="active fw-6 rounded-0" data-bs-toggle="tab">All genres</a>
                            </li>
                            <li class="nav-tab-item" role="presentation">
                                <a href="#fiction" class="fw-6 rounded-0" data-bs-toggle="tab">Fiction</a>
                            </li>
                            <li class="nav-tab-item" role="presentation">
                                <a href="#classics" class="fw-6 rounded-0" data-bs-toggle="tab">Classics</a>
                            </li>
                            <li class="nav-tab-item" role="presentation">
                                <a href="#fantasy" class="fw-6 rounded-0" data-bs-toggle="tab">Fantasy</a>
                            </li>
                            <li class="nav-tab-item" role="presentation">
                                <a href="#romance" class="fw-6 rounded-0" data-bs-toggle="tab">Romance</a>
                            </li>
                            <li class="nav-tab-item" role="presentation">
                                <a href="#shop-all" class="fw-6 rounded-0" data-bs-toggle="tab">Shop all</a>
                            </li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="fiction" role="tabpanel">
                            <div class="grid-layout" data-grid="grid-6">
                                <div class="card-product none-hover">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                        ...
                        <div class="tab-pane" id="classics" role="tabpanel">
                            <div class="grid-layout" data-grid="grid-6">
                                <div class="card-product none-hover">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                        ...
                        <div class="tab-pane" id="fantasy" role="tabpanel">
                            <div class="grid-layout" data-grid="grid-6">
                                <div class="card-product none-hover">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                        ...
                        <div class="tab-pane" id="romance" role="tabpanel">
                            <div class="grid-layout" data-grid="grid-6">
                                <div class="card-product none-hover">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                        ...
                        <div class="tab-pane" id="shop-all" role="tabpanel">
                            <div class="grid-layout" data-grid="grid-6">
                                <div class="card-product none-hover">
                                    <div class="card-product-wrapper">
                                        <a href="product-detail.html" class="product-img">
                            ...
                            <div class="col-xl-3 col-md-6 col-12">
                                <div class="footer-infor">
                                    <div class="footer-logo">
                                        <a href="index.html">
                                            <img src={{ asset("frontend/asset/images/logo/logo-white.svg") }} alt="">
                                        </a>
                                    </div>
                                    <ul>
                                        <li>
        ...
        <div class="mb-canvas-content">
            <div class="mb-body">
                <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                    ...
                    <li class="nav-mb-item">
                        <a href="../../../external.html?link=https://themeforest.net/item/ecomus-ultimate-html5-template/53417990?s_rank=3"
...
<!-- Mirrored from themesflat.co/html/ecomus/home-book-store.html by HTTraQt Website Copier/1.x [Karbofos 2012-2023] Sat, 03 Jan 2026 17:29:43 GMT -->
</html>
