                    ...
                    <div class="col-md-4 col-3">
                        <ul class="nav-icon d-flex justify-content-end align-items-center gap-20">
                            ...
                            <li class="nav-compare"><a href="compare.html"
                                    class="nav-icon-item align-items-center gap-10"><i
                                        class="icon icon-compare"></i><span class="text">Compare</span></a></li>
                            <li class="nav-wishlist"><a href="wishlist.html"
                                    class="nav-icon-item  align-items-center gap-10"><i
                                        class="icon icon-heart"></i><span class="text">Wishlist</span></a></li>
                                                    ...
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="menu-list">
                                                            ...
                                                            <li><a href="product-detail-buyx-gety.html"
                                                                    class="menu-link-text link position-relative">Buy
                                                                    X Get Y<div class="demo-label"><span
                                                                            class="demo-new">New</span></div></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                                        ...
                                                                        <div class="card-product-wrapper">
                                                                            <a href="#" class="product-img">
                                                                                <img class="lazyload img-product"
                                                                                    data-src={{ asset("frontend/asset/images/products/orange-1.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/orange-1.jpg") }}
                                                                                    alt="image-product">
                                                                                <img class="lazyload img-hover"
                                                                                    data-src={{ asset("frontend/asset/images/products/white-1.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/white-1.jpg") }}
                                                                                    alt="image-product">
                                                                            </a>
                                                                            <div
                                                                        ...
                                                                        <div class="card-product-info">
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <img class="lazyload"
                                                                                        data-src={{ asset("frontend/asset/images/products/black-1.jpg") }}
                                                                                        src={{ asset("frontend/asset/images/products/black-1.jpg") }}
                                                                                        alt="image-product">
                                                                                </li>
                                                                                <li
                                                                                    class="list-color-item color-swatch">
                                                                    ...
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product"
                                                                                    data-src={{ asset("frontend/asset/images/products/white-3.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/white-3.jpg") }}
                                                                                    alt="image-product">
                                                                                <img class="lazyload img-hover"
                                                                                    data-src={{ asset("frontend/asset/images/products/white-4.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/white-4.jpg") }}
                                                                                    alt="image-product">
                                                                            </div>
                                                                            <div
                                                                                class="list-product-btn absolute-2">
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product"
                                                                                    data-src={{ asset("frontend/asset/images/products/white-2.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/white-2.jpg") }}
                                                                                    alt="image-product">
                                                                                <img class="lazyload img-hover"
                                                                                    data-src={{ asset("frontend/asset/images/products/pink-1.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/pink-1.jpg") }}
                                                                                    alt="image-product">
                                                                            </div>
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <span
                                                                                        class="swatch-value bg_dark"></span>
                                                                                    <img class="lazyload"
                                                                                        data-src={{ asset("frontend/asset/images/products/black-2.jpg") }}
                                                                                        src={{ asset("frontend/asset/images/products/black-2.jpg") }}
                                                                                        alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                ...
                                                                <div class="swiper-slide" lazy="true">
                                                                    <div class="card-product">
                                                                        <div class="card-product-wrapper">
                                                                            <div class="product-img">
                                                                                <img class="lazyload img-product"
                                                                                    data-src={{ asset("frontend/asset/images/products/brown-2.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/brown-2.jpg") }}
                                                                                    alt="image-product">
                                                                                <img class="lazyload img-hover"
                                                                                    data-src={{ asset("frontend/asset/images/products/brown-3.jpg") }}
                                                                                    src={{ asset("frontend/asset/images/products/brown-3.jpg") }}
                                                                                    alt="image-product">
                                                                            </div>
                                                                            <div class="size-list">
                                                                                <span>S</span>
                                                                            ...
                                                                            <ul class="list-color-product">
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <span
                                                                                        class="swatch-value bg_white"></span>
                                                                                    <img class="lazyload"
                                                                                        data-src={{ asset("frontend/asset/images/products/white-5.jpg") }}
                                                                                        src={{ asset("frontend/asset/images/products/white-5.jpg") }}
                                                                                        alt="image-product">
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                        ...
                                        <ul class="menu-list">
                                            <li>
                                                <a href="about-us.html"
                                                    class="menu-link-text link text_black-2">About us</a>
                                            </li>
