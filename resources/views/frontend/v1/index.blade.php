        ...
        <div class="container">
            <div class="flat-animate-tab">
                <div class="flat-title flex-row justify-content-between align-items-center px-0 flex-wrap wow fadeInUp"
                    ...
                    <ul class="widget-tab-5 d-flex wow fadeInUp mb-0" data-wow-delay="0s" role="tablist">
                        <li class="nav-tab-item" role="presentation">
                            <a href="#all-new" class="active fw-6 rounded-0 bg-primary text-white" data-bs-toggle="tab">
        ...
        <div class="container">
            <div class="flat-animate-tab">
                <div class="flat-title flex-row justify-content-between align-items-center px-0 flex-wrap wow fadeInUp"
                    ...
                    <ul class="widget-tab-5 d-flex wow fadeInUp mb-0" data-wow-delay="0s" role="tablist">
                        <li class="nav-tab-item" role="presentation">
                            <a href="#all-default" class="active fw-6 rounded-0 bg-success text-white" data-bs-toggle="tab">
