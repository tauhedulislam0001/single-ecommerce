    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('category.update', $category->id) }}">
                ...
                <div class="form-group">
                    <label for="is_megamenu">Megamenu Status</label>
                    <select name="is_megamenu" class="form-control">
                        <option value="">--Select status--</option>
                        <option value="1" {{ $category->is_megamenu == 1 ? 'selected' : '' }}>Show</option>
                        <option value="0" {{ $category->is_megamenu == 0 ? 'selected' : '' }}>Hide</option>
                    </select>
                </div>
                {{-- {{$parent_cats}} --}}
                {{-- {{$category}} --}}
